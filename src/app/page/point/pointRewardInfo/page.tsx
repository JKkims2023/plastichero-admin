...
export default function Home() {
    ...
    const page_info = 'Home > 포인트관리 > 포인트 제공내역';
    ...
    const get_RewardInfo = async() => {
      ...
      try{
        ...
        const response = await fetch('/api/point/rewardList', {
        ...
        if (response.ok) {
          ...
          // Summary 정보 계산
          const total = data.result_data.reduce((sum, item) => sum + Number(item.po_point), 0);
          const count = data.result_data.length;
          const users = new Set(data.result_data.map(item => item.mb_id)).size;
  ...
  return (
    ...
    <div style={{display:'flex', flexDirection:'column',  width:'100%', height:'100vh',  paddingLeft:'20px', paddingRight:'20px',}}>
      ...
      <div style={{}}>
          <Typography sx={{fontSize:"20px",  color: '#1f1f26', marginLeft:"0px", marginTop:"10px", fontWeight:'bold' }}>
              포인트 제공내역 (PlasticHero ➞ User)
          </Typography>
      </div>

      {/* Summary 정보 영역 수정 */}
      <Grid container spacing={2} sx={{ mt: 2, mb: 2, marginTop:"-10px" }}>
        <Grid item xs={4}>
          <Box sx={{ 
            p: 2, 
            bgcolor: '#f8f9fa', 
            ...
            <Typography sx={{fontSize: "24px", fontWeight: "bold", color: "#1f1f26"}}>
              {summaryInfo.totalPoints.toLocaleString()}P
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
          <Box sx={{ 
            ...
            <Typography sx={{fontSize: "24px", fontWeight: "bold", color: "#1f1f26"}}>
              {summaryInfo.totalCount.toLocaleString()}회
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
          <Box sx={{ 
            ...
            <Typography sx={{fontSize: "24px", fontWeight: "bold", color: "#1f1f26"}}>
              {summaryInfo.uniqueUsers.toLocaleString()}명
            </Typography>
          </Box>
        </Grid>
      </Grid>
            ...
            <div style={{display:"flex", float:"left", marginLeft:"auto", alignContent:'center', alignItems:'center', justifyContent:'center'}}>
                ...
                <div style={{display:"flex", float:"left", alignContent:'center', alignItems:'center', justifyContent:'center'}}>
                    ...
                    <FormControl fullWidth  style={{ width:"110px",marginTop:"0px", marginLeft:"8px", backgroundColor:'white', color:'black'}}>
                        ...
                        <MenuItem style={{fontSize:13}} value={30}>SWAP Point 교환</MenuItem>
                        <MenuItem style={{fontSize:13}} value={40}>관리자에서 포인트 지급</MenuItem>
    ...
    //                      backgroundColor: "#f0f0f0",
        ...
        >
          ...
          <Typography variant="h6" color="inherit">포인트 제공내역을 불러오는 중입니다</Typography>
        </Backdrop>
